...
//  @override
//  Widget build(BuildContext context) {
//    final s = Provider.of<StudentBeforeProvider>(context);
//    final lastName = s.student != null ? s.student.lastName : '';
//    final firstName = s.student != null ? s.student.firstName : '';
//    return ListView(
//      children: <Widget>[
//        Row(
...
//              padding: const EdgeInsets.all(8),
//              child: Text(
//                s.student != null ? '出席番号: ${s.student.number}' : 'NOT NUMBER',
//                style: const TextStyle(
//                  fontSize: 32,
//                ),
//              ),
